...
const DISABLE_ENV_FLAG = 'SBBGT_DISABLE_CODEX_TRUST_RPC'
const LEGACY_DISABLE_ENV_FLAG = 'ORCA_DISABLE_CODEX_TRUST_RPC'
...
export function grantManagedCodexHookTrust(
  ...
  try {
    if (process.env[DISABLE_ENV_FLAG] === '1' || process.env[LEGACY_DISABLE_ENV_FLAG] === '1') {
