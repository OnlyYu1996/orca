...
const LOGIN_PREFLIGHT_MARKER = 'SBBGT_LOGIN_PREFLIGHT_OK'
 ...
 */
const DISABLE_ENV_VAR = 'SBBGT_DISABLE_MACOS_LOGIN_SHELL'
const LEGACY_DISABLE_ENV_VAR = 'ORCA_DISABLE_MACOS_LOGIN_SHELL'

let cachedLoginPreflightResult: boolean | null = null
let loginPreflightInFlight: Promise<boolean> | null = null

function isDisabledByEnv(): boolean {
  // 新变量优先，旧变量只用于兼容已有自动化与诊断脚本。
  const value = process.env[DISABLE_ENV_VAR] ?? process.env[LEGACY_DISABLE_ENV_VAR]
