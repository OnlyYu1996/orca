...
export const VM_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'sbbgt vm recipe doctor <recipe-id> [--repo-path <path>] [--provision|--connect] [--json]',
    ...
    examples: [
      'sbbgt vm recipe doctor cloud-sandbox',
      'sbbgt vm recipe doctor cloud-sandbox --repo-path /path/to/repo --json',
      'sbbgt vm recipe doctor cloud-sandbox --provision --json'
    ]
  }
]
