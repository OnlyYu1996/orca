...
describe('ai vault resume command runtime', () => {
  ...
  it('copies a real-home Codex command that clears inherited homes in PowerShell', () => {
    ...
    expect(
      ...
      "Remove-Item Env:CODEX_HOME -ErrorAction SilentlyContinue; Remove-Item Env:SBBGT_CODEX_HOME -ErrorAction SilentlyContinue; Remove-Item Env:ORCA_CODEX_HOME -ErrorAction SilentlyContinue; Set-Location -LiteralPath 'C:\\Users\\alice\\repo'; codex 'resume' 'session one'"
    )
  })
  ...
  it('copies a real-home Codex command that clears inherited homes in cmd', () => {
    ...
    expect(
      ...
      'set "CODEX_HOME=" & set "SBBGT_CODEX_HOME=" & set "ORCA_CODEX_HOME=" & cd /d "C:\\Users\\alice\\repo" && codex "resume" "session one"'
    )
  })
  ...
  it('copies a real-home Codex command that clears inherited homes in POSIX shells', () => {
    ...
    expect(
      ...
      "unset CODEX_HOME; unset SBBGT_CODEX_HOME; unset ORCA_CODEX_HOME; cd '/home/alice/repo' && codex 'resume' 'session one'"
    )
  })
  ...
  it('deletes inherited Codex homes when resuming a real-home session', () => {
    ...
    expect(
      ...
      envToDelete: ['CODEX_HOME', 'SBBGT_CODEX_HOME', 'ORCA_CODEX_HOME']
    })
  })
