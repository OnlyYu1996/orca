        ...
        if (
          ...
          toast.success(
            translate(
              ...
              'Windows Firewall now allows 赛博包工头 Mobile on private networks'
            )
          )
          return
        }
              ...
              {networkIsPublic
                ...
                : blockingRuleDetected
                  ? translate(
                      ...
                      'Windows may be blocking 赛博包工头 Mobile'
                    )
                  : translate(
            ...
            <p className="text-xs text-muted-foreground">
              {networkIsPublic
                ? translate(
                    ...
                    'Change this trusted Wi-Fi network to Private before allowing 赛博包工头 Mobile connections.'
                  )
                : blockingRuleDetected
                  ? translate(
                      'auto.components.mobile.WindowsFirewallNotice.blocked-description',
                      'An existing inbound Block rule can override the pairing exception. Repair removes conflicting TCP rules for this 赛博包工头 app, then allows port {{port}} on Private networks.',
                      { port: firewallStatus.port }
                    )
                  : translate(
                      'auto.components.mobile.WindowsFirewallNotice.missing-description',
                      'Windows may block the pairing server. Add a rule for this 赛博包工头 app and TCP port {{port}} on Private networks.',
                      { port: firewallStatus.port }
                    )}
            </p>
          </div>
