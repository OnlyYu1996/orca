...
export const TERMINAL_GIT_CREDENTIAL_GUARD_POLICY_ENV =
  'SBBGT_INTERNAL_TERMINAL_GIT_CREDENTIAL_GUARD_POLICY'
export const LEGACY_TERMINAL_GIT_CREDENTIAL_GUARD_POLICY_ENV =
...
export function applyTerminalGitCredentialPromptGuard(
  ...
  const explicitlyGuarded =
    env[TERMINAL_GIT_CREDENTIAL_GUARD_POLICY_ENV] === 'guard' ||
    env[LEGACY_TERMINAL_GIT_CREDENTIAL_GUARD_POLICY_ENV] === 'guard'
