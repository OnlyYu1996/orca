...
export const SERVE_UPDATE_HANDOFF_PATH_ENV = 'SBBGT_SERVE_UPDATE_HANDOFF_PATH'
export const LEGACY_SERVE_UPDATE_HANDOFF_PATH_ENV = 'ORCA_SERVE_UPDATE_HANDOFF_PATH'
...
export type ServeSupervisorMessage = {
  type: 'sbbgt:serve-ready' | 'orca:serve-ready'
  version: string
  runtimeId: string
}
...
export function parseServeSupervisorMessage(value: unknown): ServeSupervisorMessage | null {
  ...
  if (
    !['sbbgt:serve-ready', 'orca:serve-ready'].includes(String(message.type)) ||
