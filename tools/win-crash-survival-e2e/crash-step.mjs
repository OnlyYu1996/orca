...
//
// GitHub #7742: when 赛博包工头's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user 赛博包工头 on the same box is never touched.
 */
