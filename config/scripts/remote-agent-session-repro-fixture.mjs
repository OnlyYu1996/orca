...
const markerPath = process.env.SBBGT_REPRO_SPAWN_MARKER ?? process.env.ORCA_REPRO_SPAWN_MARKER
const exitTriggerPath = process.env.SBBGT_REPRO_EXIT_TRIGGER ?? process.env.ORCA_REPRO_EXIT_TRIGGER
